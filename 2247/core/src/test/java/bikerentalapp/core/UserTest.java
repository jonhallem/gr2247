...
public class UserTest {
    ...
    void testNewUser() {
        ...
        assertThrows(IllegalArgumentException.class, () -> {
            new User(" ", "test123");
        }, "IllegalArgument skal utløses om brukernavnet er blankt");
        assertThrows(IllegalArgumentException.class, () -> {
            new User("a1", "test123");
        }, "IllegalArgument skal utløses om brukernavnet er for kort");
        assertThrows(IllegalArgumentException.class, () -> {
            new User("@@@@", "test123");
        }, "IllegalArgument skal utløses om brukernavnet inneholder noe annet enn bokstaver og tall");

        assertThrows(IllegalArgumentException.class, () -> {
            new User("testUsername", null);
        }, "IllegalArgument skal utløses om passord er 'null'.");
        assertThrows(IllegalArgumentException.class, () -> {
            new User("testUsername", "");
        }, "IllegalArgument skal utløses om passord er blankt.");
        assertThrows(IllegalArgumentException.class, () -> {
            new User("testUsername", "p1");
        }, "IllegalArgument skal utløses om passord er kortere enn tre tegn.");
        assertThrows(IllegalArgumentException.class, () -> {
            new User("testUsername", "passord");
        }, "IllegalArgument skal utløses om passordet ikke inneholder tall og bokstaver.");
        assertThrows(IllegalArgumentException.class, () -> {
            new User("testUsername", "123456");
        }, "IllegalArgument skal utløses om passordet ikke inneholder tall og bokstaver.");
    }
    ...
    void testAddBike() {
        ...
        assertThrows(IllegalStateException.class, () -> {
            user.setBike(bike2);
        }, "IllegalState skal utløses dersom du setter en ny sykkel for en bruker som allerede har en sykkel.");
    }
    ...
    void testReturnAndRomoveBike() {
        ...
        assertThrows(IllegalStateException.class, () -> {
            user.removeAndReturnBike();
        }, "IllegalState skal utløses dersom du prøver å fjerne en sykkel når du ikke har satt en. ");
